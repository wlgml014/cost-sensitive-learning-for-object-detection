...
class Trainer(object):
    ...
    def save_model(self, is_best=False):
        ...
        if is_best:
            torch.save(state, os.path.join(self.config.checkpoint_dir, 'my_best_checkpoint3.pth'))
        torch.save(state, os.path.join(self.config.checkpoint_dir, 'my_checkpoint3.pth'))
