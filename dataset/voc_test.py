...
class VOCTestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img, boxes, classes, hm, info, sample, image_id
    ...
    def parse_annotation(self, annotation_path):
        ...
        labels = list()
        difficulties = list()
        img_id = int(root.find('image_id').text)
        ...
        return {'boxes': boxes, 'labels': labels, 'difficulties': difficulties, 'image_id': img_id}

    def collate_fn(self, data):
        imgs_list, boxes_list, classes_list, hm_list, infos, sample, image_id = zip(*data)
        ...
        return batch_imgs, batch_boxes, batch_classes, batch_hms, infos, sample, image_id
